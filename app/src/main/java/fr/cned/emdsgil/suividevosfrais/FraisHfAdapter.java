...
class FraisHfAdapter extends BaseAdapter {
	...
	public View getView(int index, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.cmdSuppHf = (ImageView) convertView.findViewById(R.id.cmdSuppHf);
		...
		holder.cmdSuppHf.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				// affectation à une variable de l'index de l'image selectionnée
				int position = (Integer)v.getTag() ;
				// appel de la méthode supprimmant un frais Hors forfait
